...
@Repository
public class NovusShopDaoImpl implements ShopDao {
    ...
    public List<Product> get(String searchRequest) {
        String query = "SELECT id, product, volume, article_novus "
                + "FROM products "
        ...
        try (Connection connection = ConnectionUtil.getConnection();
            ...
            while (resultSet.next()) {
                if (resultSet.getString("article_novus") == null) {
                    continue;
                }
                ...
                product.setArticle(resultSet.getString("article_novus"));
