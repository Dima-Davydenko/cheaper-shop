...
@Repository
public class AtbShopDaoImpl implements ShopDao {
    ...
    public List<Product> get(String searchRequest) {
        String query = "SELECT id, product, volume, article_atb "
                + "FROM products "
        ...
        try (Connection connection = ConnectionUtil.getConnection();
            ...
            while (resultSet.next()) {
                if (resultSet.getString("article_atb") == null) {
                    continue;
                }
                ...
                product.setArticle(resultSet.getString("article_atb"));
